...
export default class App extends React.Component {
  ...
  // static defaultProps = {
  //   indicatorSeconds: 'indicator seconds ' + (this.state.date.getSeconds() === 0 ? '' : 'transition-effect'),
  //   indicatorMinutes: 'indicator minutes ' + (this.state.date.getMinutes() === 0 ? '' : 'transition-effect'),
  //   indicatorHours: 'indicator hours ' + (this.state.date.getHours() === 0 ? '' : 'transition-effect'),
  // };

  indicatorSeconds() {
    return 'indicator seconds ' + (this.state.date.getSeconds() === 0 ? '' : 'transition-effect');
  }

  indicatorMinutes() {
    return 'indicator minutes ' + (this.state.date.getMinutes() === 0 ? '' : 'transition-effect');
  }

  indicatorHours() {
    return 'indicator hours ' + (this.state.date.getHours() === 0 ? '' : 'transition-effect');
  }
  ...
  render() {
    ...
    return (
      ...
      //         // id="hours-indicator"
      //         className={
      //           'indicator hours ' + (this.state.date.getHours() === 0 ? '' : 'transition-effect')
      //         }
      //         style={divStyleHours}
      //       ></div>
      //       <div
